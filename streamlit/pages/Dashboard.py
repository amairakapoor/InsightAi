...
st.set_page_config(page_title="Dashboard — InsightAI", page_icon="📊", layout="wide")
require_login()
...
if st.session_state.get("last_response"):
    ...
    st.markdown("##### 📄 Export")
    e1, e2 = st.columns(2)
    if e1.button("⬇️ Prepare PDF report", use_container_width=True):
    ...
    if e2.button("⬇️ Prepare CSV export", use_container_width=True):
